...
if(NOT "include;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.2;/usr/include/ignition/math2;/usr/include/OGRE " STREQUAL " ")
  set(gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.2;/usr/include/ignition/math2;/usr/include/OGRE")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marifer/ros-opencv/maria/mybot_ws/install/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/marifer/ros-opencv/maria/mybot_ws/install/lib;/home/marifer/mybot_ws/devel/lib;/opt/ros/kinetic/lib)
