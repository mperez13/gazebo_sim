...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/install)
...
if(NOT "/home/marifer/ros-opencv/maria/mybot_ws/devel/include;/usr/include " STREQUAL " ")
  set(gazebo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/marifer/ros-opencv/maria/mybot_ws/devel/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marifer/ros-opencv/maria/mybot_ws/src/gazebo_ros_pkgs/gazebo_ros/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
...
set(depends "roslib;roscpp;geometry_msgs;std_srvs;tf;rosgraph_msgs;dynamic_reconfigure;message_generation;std_msgs;gazebo_msgs")
