...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_msgs_SOURCE_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/src/gazebo_ros_pkgs/gazebo_msgs)
  set(gazebo_msgs_DEVEL_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/devel)
  ...
  set(gazebo_msgs_INSTALL_PREFIX /home/marifer/ros-opencv/maria/mybot_ws/install)
...
if(NOT "/home/marifer/ros-opencv/maria/mybot_ws/devel/include " STREQUAL " ")
  set(gazebo_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/marifer/ros-opencv/maria/mybot_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marifer/ros-opencv/maria/mybot_ws/src/gazebo_ros_pkgs/gazebo_msgs/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
